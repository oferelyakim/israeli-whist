...
import { useQuartetsMultiplayer } from '../hooks/useQuartetsMultiplayer';
...
export default function QuartetsMultiplayerScreen({
  roomId,
  humanSeat,
  isHost,
  onBack,
  ...
  const {
    ...
    humanSeat: seat,
    resolveRequest,
  } = useQuartetsMultiplayer(roomId, humanSeat, isHost);
